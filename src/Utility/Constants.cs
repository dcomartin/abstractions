...
namespace Unity
{
    internal static class Constants
    {
        ...
        public const string FactoryResolutionFailed = "Resolution of the DelegateInjectionFactory pipeline @delegate failed, type = '{0}', name = '{1}'.";
        ...
        public const string InvalidMember = "This Injection Member is invalid";
